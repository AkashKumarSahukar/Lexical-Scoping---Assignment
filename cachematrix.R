...
## Write a short comment describing this function - The first function, makeCacheMatrix creates a special “matrix”, which is really a list containing a function to:
